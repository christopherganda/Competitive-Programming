//var gmScriptName = 'groupmanalyticsV2-id.js';
// Turbine code

function gmtagr()
{
    // set core tagr variables
	this.gmScriptName = 'groupmanalyticsV2-id.js'; // This parameter needs to match the name of the JS file *as saved to the CDN*
	this.trackingDomain = 'id-gmtdmp.mookie1.com'; // Use the tracking domain from the TAGr tag generated in the UI
    this.acid = 31; // Use the account ID (acid) from the tag generated in the UI => will be set in tagr meta data
    this.inst = 'NA'; // Use the instance (inst) from the tag generated in the UI => will be set in tagr meta data
    this.tagid = 'V2_10603'; // Use the tag id from the tag generated in the UI
	this.platformID = 'SZMK'; // => will be set in tagr meta data
